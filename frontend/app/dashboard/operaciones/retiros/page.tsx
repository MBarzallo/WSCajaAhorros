...
export default function RetirosPage() {
  ...
  const retirar = async () => {
    ...
    setLoading(true);
    try {
      await movimientosService.retirar({
        cuentaId,
        monto: Number(monto),
        descripcion,
      });
      ...
      alert(e?.message || "Error al realizar el retiro");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <main className="min-h-screen bg-slate-100 p-10">
      <div className="max-w-xl mx-auto bg-white rounded-xl shadow border p-8">
        ...
        <h1 className="text-xl font-semibold mb-6">Retiros</h1>
        ...
        <input
          ...
          placeholder="Retiro en ventanilla"
        />
